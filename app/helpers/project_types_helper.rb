...
module ProjectTypesHelper
 def modules_multiselect(project_type_id, choices, label,options={})
    
    modules = EnabledModule.where(project_type_id: project_type_id).pluck(:name)
