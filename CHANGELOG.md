...
* ProjectsController#create and ProjectsController#copy in order to rescue 
  from validation errors during spreadsheet copying

## 4.2.1 - 2022-08-08

### Changed

* error messages when importing project with wrong id

## 4.2.0 - 2022-06-29

### Added

* project import based on project types

### Fixed

* (+/-) toggle of project types in custom fields
* status filter of project types

## 4.1.2 - 2022-03-05

### Fixed

* method undefined in ProjectTypeFormat
...
* missing translation for project type master permissions
