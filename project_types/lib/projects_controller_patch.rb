...
module ProjectsControllerPatch
  ...
  module InstanceMethods
    ...
    # Updates the attributes and uses project_params instead of saving only
    ...
    def project_params
      params.require(:project).permit(:name, :description, :homepage, :is_public, :parent_id, :identifier, :inherit_members, :default_version_id, enabled_module_names:[], :custom_field_values => [projects_custom_field_ids], issue_custom_field_ids:[], tracker_ids:[],projects_project_type_attributes: [:id, :project_type_id])
    end
  end # module InstanceMethods
  
end # module ProjectsControllerPatch
