  ...
  module Patches
    module ProjectsControllerPatch
      ...
      module InstanceMethods
        ...
        # Updates nested attributes (projects_project_types_attributes) with nested_params by using strong parameters
        ...
        # Creates nested attributes (projects_project_types_attributes) with nested_params by using strong parameters
        ...
        # Uses strong parameters for nested attributes only
        def nested_params
          params.require(:project).permit(projects_project_type_attributes: [:id, :project_type_id])
        end   
      end 
    end
  end
